...
class TranslationKeys {
	static final translations = TranslationHelper.translations;
	...
	static String get waste_type_general_description => translations["waste_type"]["general"]["description"];
	static String get waste_type_food_name => translations["waste_type"]["food"]["name"];
	static String get waste_type_food_description => translations["waste_type"]["food"]["description"];
	static String get waste_type_paper_name => translations["waste_type"]["paper"]["name"];
	static String get waste_type_paper_description => translations["waste_type"]["paper"]["description"];
	static String get waste_type_plastic_name => translations["waste_type"]["plastic"]["name"];
	static String get waste_type_plastic_description => translations["waste_type"]["plastic"]["description"];
	static String get waste_type_aluminium_name => translations["waste_type"]["aluminium"]["name"];
	static String get waste_type_aluminium_description => translations["waste_type"]["aluminium"]["description"];
	static String get waste_type_glass_name => translations["waste_type"]["glass"]["name"];
	static String get waste_type_glass_description => translations["waste_type"]["glass"]["description"];
	static String get waste_type_biohazard_name => translations["waste_type"]["biohazard"]["name"];
	static String get waste_type_biohazard_description => translations["waste_type"]["biohazard"]["description"];
	static String get waste_type_electronic_name => translations["waste_type"]["electronic"]["name"];
	static String get waste_type_electronic_description => translations["waste_type"]["electronic"]["description"];
	...
	static String get chalenge_level_select_page_title => translations["chalenge_level_select_page"]["title"];
	...
	static String get tutorial_dialog_mode_learning_title => translations["tutorial_dialog"]["mode"]["learning"]["title"];
	static String get tutorial_dialog_mode_learning_desc => translations["tutorial_dialog"]["mode"]["learning"]["desc"];
	static String get tutorial_dialog_mode_chalenge_title => translations["tutorial_dialog"]["mode"]["chalenge"]["title"];
	static String get tutorial_dialog_mode_chalenge_desc => translations["tutorial_dialog"]["mode"]["chalenge"]["desc"];
	...
	static String get tutorial_dialog_board_title => translations["tutorial_dialog"]["board"]["title"];
	static String get tutorial_dialog_board_line1 => translations["tutorial_dialog"]["board"]["line1"];
	static String get tutorial_dialog_board_line2 => translations["tutorial_dialog"]["board"]["line2"];
	static String get tutorial_dialog_helper_title => translations["tutorial_dialog"]["helper"]["title"];
	static String get tutorial_dialog_helper_knowledge_title => translations["tutorial_dialog"]["helper"]["knowledge"]["title"];
	static String get tutorial_dialog_helper_knowledge_decs => translations["tutorial_dialog"]["helper"]["knowledge"]["decs"];
	static String get tutorial_dialog_helper_hint_title => translations["tutorial_dialog"]["helper"]["hint"]["title"];
	static String get tutorial_dialog_helper_hint_decs => translations["tutorial_dialog"]["helper"]["hint"]["decs"];
	...
	static String get chalenge_end_dialog_new_high_score => translations["chalenge_end_dialog"]["new_high_score"];
	static String get chalenge_end_dialog_high_score_is => translations["chalenge_end_dialog"]["high_score_is"];
	static String get chalenge_end_dialog_play_again => translations["chalenge_end_dialog"]["play_again"];
	...
	static String get learning_end_dialog_star3_sub => translations["learning_end_dialog"]["star3_sub"];
	static String get learning_end_dialog_star2 => translations["learning_end_dialog"]["star2"];
	static String get learning_end_dialog_star2_sub => translations["learning_end_dialog"]["star2_sub"];
	static String get learning_end_dialog_star1 => translations["learning_end_dialog"]["star1"];
	static String get learning_end_dialog_star1_sub => translations["learning_end_dialog"]["star1_sub"];
	static String get learning_end_dialog_star0 => translations["learning_end_dialog"]["star0"];
	static String get learning_end_dialog_star0_sub => translations["learning_end_dialog"]["star0_sub"];
	static String get learning_end_dialog_play_again => translations["learning_end_dialog"]["play_again"];
